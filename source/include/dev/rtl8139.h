...
// https://wiki.osdev.org/PCI -- Header Type 0x2 (PCI-to-CardBus bridge)
#define PCI_CONFIG_ADDR                 0xCF8
#define PCI_CONFIG_DATA                 0xCFC
#define PCI_CONFIG_ID                   0x00
#define PCI_CONFIG_CMD_STAT             0x04
#define PCI_CONFIG_BASE_ADDR            0x10
#define PCI_CONFIG_INT                  0x3C
...
#ifdef NET_DRIVE_DBG
    #define NET_DRIVE_DBG_PRINT(fmt, ...) dbg_info(fmt, ##__VA_ARGS__)
#else
    #define NET_DRIVE_DBG_PRINT(fmt, ...) do { } while(0)
#endif
